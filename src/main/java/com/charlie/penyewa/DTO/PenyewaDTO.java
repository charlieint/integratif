package com.charlie.penyewa.DTO;
...
public class PenyewaDTO {
    ...
    public PenyewaDTO(Long idPenyewa, String namaPenyewa, String NIKPenyewa, String noTlpnPenyewa, String alamatPenyewa, boolean statusSedangSewa, boolean statusHapus) {
